...
class AssistantServiceTest {
    ...
    @Test
    void addsHighestRankedCakeFromLatestBirthdayRecommendations() {
        when(aiClient.interpret("Add the cake to my cart."))
                .thenReturn(new CustomerIntent(
                        AssistantIntentType.ADD_TO_CART,
                        null,
                        null,
                        null,
                        1,
        ...
        when(recommendationService.findActiveProductsByIds(
                List.of("P004", "P001", "P005")))
                .thenReturn(List.of(birthdayCake, chocolateCake, cupcake));
